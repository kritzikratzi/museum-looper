OMXPlayer-Sync (Modified)
==============

This is a modified version of [omxplayer-sync](https://github.com/turingmachine/omxplayer-sync) with the following changes: 

* Modified sync mechanism for faster sync (also does small pauses instead of resync when it's a tiny bit ahead)
* Also emits time and reset through OSC (port 1667)
